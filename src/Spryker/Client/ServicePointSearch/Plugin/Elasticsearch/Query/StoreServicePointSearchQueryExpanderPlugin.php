 ...
 */
class StoreServicePointSearchQueryExpanderPlugin extends AbstractPlugin implements QueryExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    protected function addStoreFilterToQuery(Query $query): void
    {
        ...
        $matchQuery = (new MatchQuery())
            ->setField(ServicePointIndexMap::STORE, $this->getStoreName());
